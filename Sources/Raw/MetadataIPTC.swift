...
@objcMembers public class MetadataIPTC : MetadataBase {

    // MARK: Children
    internal override class var childrenMappings: [String: MetadataBase.Type] {
        return [kCGImagePropertyIPTCCreatorContactInfo.string: MetadataIPTCContactInfo.self]
    }
    
    public var creatorContactInfo: MetadataIPTCContactInfo? {
