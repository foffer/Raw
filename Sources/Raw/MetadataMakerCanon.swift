...
@objcMembers public class MetadataMakerCanon : MetadataBase {
    ...
    public var continuousDrive: MetadataCIFF.ContinousDrive? {
    ...
    public var whiteBalance: MetadataCIFF.WhiteBalance? {
