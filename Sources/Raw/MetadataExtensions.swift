...
public extension PHAsset {
    /*
     ...
     They are not available via any public API, at least in iOS 14.5, and they are not saved into the image metadata, so Metadata can't obtain them easily.
